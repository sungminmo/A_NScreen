...
public class MyMainListViewAdapter extends BaseAdapter {
    ...
    public MyMainListViewAdapter(Context c, View.OnClickListener onClickListener) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.listview_my_main, parent, false);
        }
        ...
        try {
            ...
            TextView titleTextView = ViewHolder.get(convertView, R.id.my_main_textview_program_title);
