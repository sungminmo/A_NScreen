...
public class MySubListViewAdapter extends BaseAdapter {
    ...
    public MySubListViewAdapter(Context c, View.OnClickListener onClickListener) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.listview_my_sub, parent, false);
        }
        ...
        try {
            ...
            TextView titleTextView = ViewHolder.get(convertView, R.id.my_sub_textview_program_title);
