...
public class WidevineSamplePlayer extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        WidevineDrm.Settings.DRM_SERVER_URI = settings.getString("drmServer", WidevineDrm.Settings.DRM_SERVER_URI);
        WidevineDrm.Settings.DEVICE_ID = settings.getString("deviceId", WidevineDrm.Settings.DEVICE_ID);
        WidevineDrm.Settings.PORTAL_NAME = settings.getString("portalId", WidevineDrm.Settings.PORTAL_NAME);
        SettingsActivity.CONTENT_PAGE = settings.getString("contentPage", SettingsActivity.CONTENT_PAGE);

        setContentView(R.layout.widevine_sampleplayer_main);
